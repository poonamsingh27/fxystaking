/**
 *Submitted for verification at polygonscan.com on 2023-09-16
*/
...
// File: contracts/FXYStaking1.sol
...
/**
 * @title FXYStaking
 * @dev A smart contract for staking FXY tokens with various durations and earning interest.
 */
...
contract FXYStaking is Ownable {
    ...
    uint256 public totalFXYLocked;
    uint256[] public stakeDurationInSec;

 // Structure to store information about each staking duration
 ...
 // Events to log staking and withdrawal actions
    event Staked(
 ...
 // Modifier to ensure that the penalty percentage is not too high
 ...
 /**
     * @dev Constructor to initialize the FXYStaking contract.
     * @param _fxyToken Address of the FXY token.
     * @param _feeReceiver Address that receives penalty fees.
     * @param _minFXY Minimum amount of FXY required for staking.
     * @param _preMatureFXYPenalty Penalty percentage for pre-mature withdrawals.
     * @param _baseAPY Base Annual Percentage Yield (APY) for interest calculations.
     * @param _stakeDurationInDays Array of stake durations in days.
     * @param _multiplier Array of corresponding multipliers for stake durations.
     */
    ...
    constructor(
        ...
        /**
     * @dev Function to calculate the maturity amount based on the staked FXY amount and duration.
     * @param _stakedFXY Amount of FXY tokens staked.
     * @param _stakeDurationInSec Duration of the stake in seconds.
     * @return Maturity amount after earning interest.
     */
    ...
    /**
     * @dev Function to stake FXY tokens for a specified duration.
     * @param _fxyAmount Amount of FXY tokens to stake.
     * @param _stakeDurationInSec Duration of the stake in seconds.
     */
    ...
    /**
     * @dev Function to withdraw staked FXY tokens based on the specified index.
     * @param _index Index of the deposit to be withdrawn.
     */

    function withdraw(uint256 _index) external {
        address user = msg.sender;

        require(_index < userDeposits[user].deposits.length, "Invalid Index");
        DepositInfo memory userDepositInfo = userDeposits[user].deposits[_index];

        uint256 fxyStaked = userDepositInfo.fxyStaked;

        totalFXYLocked -= fxyStaked;
        userTotalDeposits[user] -= fxyStaked;
   ...
   /**
     * @dev Function to update the pre-mature withdrawal penalty percentage.
     * @param _penaltyPercentage New penalty percentage.
     */
     ...
     /**
     * @dev Function to update the base Annual Percentage Yield (APY).
     * @param _baseAPY New base APY for interest calculations.
     */
  ...
  /**
     * @dev Function to update the minimum FXY amount required for staking.
     * @param _minFXY New minimum FXY amount.
     */
